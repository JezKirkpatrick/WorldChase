...
// concurrently, each working from a stale duplicate-check snapshot, and picked
// the same landmark for multiple rounds (e.g. Christ the Redeemer x6 in one event).
